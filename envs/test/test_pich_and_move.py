...
def test():
    ...
    state = state.switch_tools('Gripper', np.array([0.5, 0.15, 0.5, 0., 0., 0., 0.5]), friction=10., size=(0.02, 0.15, 0.02), action_scale=(0.015, 0.015, 0.015, 0., 0., 0.0, 0.015), softness=0.)
    images = []
    env.set_state(state)
